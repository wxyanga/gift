			...
			<el-tab-pane label="批量录入" name="second">
						...
						<el-autocomplete style="width:80%" v-model="validatorForm.setNewAddress" :fetch-suggestions="querySearch" :debounce="100" @select="handleSelect">
							<template slot-scope="props">
								<div style="position: relative;">
									{{ `${props.item.name}/${props.item.prov}/${props.item.city}/${props.item.county}/${props.item.address}/${props.item.tel}` }}
				...
				<el-form :model="validatorForm" ref="form2" class="cust-exp-type" :rules="rules2" label-width="150px">
					...
					<el-form-item label="录入参照格式">
						<div>
							<span style="background:green;color:#fff;padding:5px 10px;margin-right:10px">电商平台订单号 商品名称 收货人姓名 收货人电话 收货详细地址</span>
